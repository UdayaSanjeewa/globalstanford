...
function MbaManagementHeading() {
  return (
    ...
    <motion.div
        ...
        <p className='text-white font-catamaran font-[800] text-[20px] lg:text-[35px]'>MBA in Management</p>
        <p className='text-white font-[500] font-catamaran lg:text-[20px]'>Designed for Employees who are in the field of management at executive level, the MBA is an assignment based one.</p>
    </motion.div>
...
export default MbaManagementHeading;
