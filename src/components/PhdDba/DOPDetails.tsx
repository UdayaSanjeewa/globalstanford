    ...
    <div className="ml-[6%] mb-[5%] mr-[10%] sm:mr[10%]">
      ...
      >
        ...
        We are offer the opportunity to specialize in a particular
         area like Education and Management. This can help you tailor your studies and career path.
        </p>
      </motion.div>
      <h1
        className="font-catamaran  sm:text-[26px] mt-8  text-[20px]  uppercase animate-typing overflow-hidden 
      ...
      >
        ...
        the candidate's research question, methodology, findings, and contribution to the existing body of knowledge.
        </p>
      </motion.div>
      ...
      >
        ...
        Traditionally, a PhD program is a significant time investment. It typically involves three to four years of full-time study, though it can take up to six years or more for part-time students. During this period, the student conducts their research, takes coursework, and eventually writes up their thesis or dissertation.
         This final document showcases their expertise and original contribution to their chosen field of study.
        </p>

        <p className="text-[16px] sm:text-[18px]">
        In essence, a PhD is a journey of deep exploration and knowledge creation within a specialized field. 
        It signifies not just extensive knowledge but also the
         ability to conduct independent research and make original contributions to a particular area of study.
        </p>
      </motion.div>
