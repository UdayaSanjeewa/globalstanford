  ...
  return (
    <div className="bg-gradient-to-r from-blue-900/10 to-blue-900/10">
      ...
      <div className="ml-[6%] mr-[10%] mb-[6%]">
        ...
        <AnimatedBox>
          <p>
            The Advanced Diploma in Accounting & Finance is an intensive,
            career-focused program designed for school leavers and working
            professionals seeking specialized, high-level skills in accounting
            and finance.
          </p>
          <p className="mt-4">
            The curriculum advances beyond foundational knowledge to cover
            complex financial reporting, strategic financial management,
            compliance, analytics, and real-world application through a
        ...
        <AnimatedBox>
          <ul className="ml-6 space-y-3 list-decimal">
            <li>Analyze complex accounting and financial problems.</li>
            <li>Design and implement effective financial strategies.</li>
            <li>Evaluate ethical, legal, and global financial implications.</li>
            <li>Synthesize financial data for informed decision-making.</li>
            <li>Communicate financial information clearly and professionally.</li>
            <li>Lead and collaborate in multidisciplinary business teams.</li>
          </ul>
        </AnimatedBox>
        ...
        <AnimatedBox>
          <ul className="ml-6 space-y-3 list-disc">
            ...
            <li>Career guidance, CV reviews & mock interviews</li>
          </ul>
        </AnimatedBox>
        ...
        <AnimatedBox>
          ...
          <Semester
            title="Semester 1 – Foundations of Business & Accounting (15 Credits)"
            items={[
          ...
          <Semester
            title="Semester 2 – Core Financial Management (15 Credits)"
            items={[
          ...
          <Semester
            title="Semester 3 – Advanced Accounting & Analysis (15 Credits)"
            items={[
          ...
          <Semester
            title="Semester 4 – Integration & Capstone (15 Credits)"
            items={[
