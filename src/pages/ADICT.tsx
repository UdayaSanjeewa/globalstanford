        ...
        <AnimatedBox>
          <Semester
            ...
            items={[
              ...
              "Programming Concepts and Logic (4 credits)",
              "Mathematics for ICT (4 credits)",
              "Communication Skills and Professionalism (3 credits)",
            ]}
          />
          <Semester
            ...
            items={[
              ...
              "Computer Networks and Data Communication (4 credits)",
              "Information Security and Cyber Ethics (3 credits)",
            ]}
          />
          <Semester
            title="Semester 3 (15 credits)"
            items={[
              "Operating Systems Theory (4 credits)",
              "Software Engineering and Project Management (4 credits)",
              "Web Technologies and Internet Concepts (4 credits)",
              "Emerging Trends in ICT (3 credits)",
            ]}
          />
          <Semester
            title="Semester 4 (15 credits)"
            items={[
              "Advanced Topics in ICT (5 credits)",
              "Research Methodology and ICT Project (5 credits)",
              "ICT in Business and Society (5 credits)",
            ]}
          />
        </AnimatedBox>
      </div>
