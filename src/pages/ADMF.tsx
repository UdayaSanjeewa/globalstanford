  ...
  return (
    <div className="bg-gradient-to-r from-blue-900/10 to-blue-900/10">
        ...
        <div className="absolute inset-0 bg-[#003478] opacity-90 flex items-center">
          <div className="ml-[6%] text-white max-w-4xl">
            <h1 className="text-[26px] sm:text-[40px] font-extrabold font-catamaran">
              Advanced Diploma in Microfinance
            </h1>
      ...
      <div className="ml-[6%] mr-[10%] mb-[6%]">
        ...
        <AnimatedBox>
          <p>
            The Advanced Diploma in Microfinance is an intensive, career-focused
            program designed for school leavers and working professionals
            seeking specialized, high-level skills in microfinance.
          </p>
          <p className="mt-4">
            The program moves beyond foundational knowledge, emphasizing
            advanced theories, strategic applications, and emerging trends
            through a scaffolded learning model.
          </p>
        </AnimatedBox>
        ...
        <AnimatedBox>
          <ul className="ml-6 space-y-3 list-decimal">
            <li>Analyze complex microfinance-related problems.</li>
            <li>Design and implement effective real-world solutions.</li>
            <li>Evaluate ethical, social, and global implications.</li>
            <li>Synthesize information for innovative decision-making.</li>
            <li>Communicate complex information to diverse audiences.</li>
        ...
        <AnimatedBox>
          <ul className="ml-6 space-y-3 list-disc">
            ...
            <li><b>Asynchronous:</b> Recorded lectures, curated readings, simulations</li>
        ...
        <AnimatedBox>
          ...
          <Semester
            title="Semester 1 – Foundations of Business Management"
            items={[
          ...
          <Semester
            title="Semester 2 – Core Business & Microfinance Practices"
            items={[
              "Brand & Service Management",
              "Consumer Behavior in Business",
              "Business Strategies",
              "Management Information Systems",
              "Microfinance Products & Delivery Methods",
            ]}
          />

          <Semester
            title="Semester 3 – Advanced Microfinance & Business Strategy"
            items={[
          ...
          <Semester
            title="Semester 4 – Integration & Application"
            items={[
